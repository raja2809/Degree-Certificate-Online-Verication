...
<head>
    ...
    <title>Degree Certificate Verification</title>

    <!-- Custom fonts for this template-->
    <link href="{{asset('admin1/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
    <link
    ...
    <div id="wrapper">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse " aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('user1.index') }}">Graduate from USIM</a>
             ...
             <li class="nav-item ">
                ...
                <div id="collapsePages" class="collapse " aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('user2.index') }}">Graduate from UM</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('user3.index') }}">Graduate from UPM</a>
        ...
        <div id="content">
            <div class="w3-content">
                <img class="mySlides" src="{{asset('admin1/img/Degree Certificate Online Verification System (1).png')}}" alt="custom_html_banner1" style="width:100%">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                                    <a class="nav-link" href="{{ route('user1.index') }}">{{ __('Guest') }}</a>
                                </li>
                        @if (Route::has('login'))
                                <li class="nav-item">
